...
return;this._auditRunning=auditRunning;this._updateButton();this._toggleUIComponents(this._auditRunning);if(this._auditRunning){WebInspector.profilingLock().acquire();this._startAudit();}else{this._stopAudit();WebInspector.profilingLock().release();}},_startAudit:function()
