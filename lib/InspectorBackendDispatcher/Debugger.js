...
proto.setBreakpointByUrl = function setBreakpointByUrl(msg, cb) {
  ...
  this._debuggerAgent.setBreakpointByUrl(successCallback(msg, cb));
}
...
proto.removeBreakpoint = function removeBreakpoint(msg, cb) {
  ...
  this._debuggerAgent.removeBreakpoint(successCallback(msg, cb));
}
...
proto.getScriptSource = function getScriptSource(msg, cb) {
  ...
  this._debuggerAgent.getScriptSource(successCallback(msg, cb));
}
