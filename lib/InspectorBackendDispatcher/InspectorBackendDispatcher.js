...
proto._registerMethods = function _registerMethods() {
  ...
  this._methods = {
    ...
    , 'Console.disable'                                  : this._console.disable
    , 'Console.clearMessages'                            : this._console.clearMessages
    , 'Console.setMonitoringXHREnabled'                  : this._console.setMonitoringXHREnabled
    , 'Console.addInspectedNode'                         : this._console.addInspectedNode
    , 'Console.addInspectedHeapObject'                   : this._console.addInspectedHeapObject
    , 'Console.setTracingBasedTimeline'                  : this._console.setTracingBasedTimeline
