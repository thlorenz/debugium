...
var methods = {
  ...
  , 'Console.enable'                                   : notImplemented
  , 'Console.disable'                                  : notImplemented
  , 'Console.clearMessages'                            : notImplemented
  , 'Console.setMonitoringXHREnabled'                  : notImplemented
  , 'Console.addInspectedNode'                         : notImplemented
  , 'Console.addInspectedHeapObject'                   : notImplemented
  , 'Console.setTracingBasedTimeline'                  : notImplemented
  , 'Network.enable'                                   : notImplemented
  , 'Network.disable'                                  : notImplemented
  , 'Network.setUserAgentOverride'                     : notImplemented
  , 'Network.setExtraHTTPHeaders'                      : notImplemented
  , 'Network.getResponseBody'                          : notImplemented
  , 'Network.replayXHR'                                : notImplemented
  , 'Network.canClearBrowserCache'                     : notImplemented
  , 'Network.canClearBrowserCookies'                   : notImplemented
  , 'Network.emulateNetworkConditions'                 : notImplemented
  , 'Network.setCacheDisabled'                         : notImplemented
...
function InspectorBackendDispatcher() {
  if (!(this instanceof InspectorBackendDispatcher)) return new InspectorBackendDispatcher();
}
...
proto.dispatch = function dispatch(msg) {
  ...
  var fn = methods[msg.method] || registeredMethods[msg.method]
